...
export default async function StokCikisPage() {
  ...
  return (
    <div className="p-6 max-w-xl mx-auto space-y-6">
      <div className="flex items-center gap-3">
        ...
        <h1 className="text-xl font-bold text-slate-800">Stok Çıkışı</h1>
      </div>
      ...
      <div className="bg-white rounded-xl border border-slate-200 p-6">
        <form action={addStockMovement} className="space-y-4">
          ...
          <div className="space-y-1.5">
            <Label htmlFor="source_type">Çıkış Nedeni</Label>
            <select
              id="source_type"
              name="source_type"
              className="flex h-9 w-full rounded-md border border-slate-200 bg-white px-3 py-1 text-sm shadow-sm focus:outline-none focus:ring-2 focus:ring-green-600"
            >
              ...
              <option value="manual">Manuel Çıkış</option>
          ...
          <div className="space-y-1.5">
            ...
            <Textarea id="notes" name="notes" placeholder="Çıkış nedeni, müşteri adı vb." rows={2} />
          </div>

          <div className="flex gap-3 pt-2">
            <Button type="submit" className="flex-1 bg-red-600 hover:bg-red-700 text-white">Stok Çıkışı Kaydet</Button>
